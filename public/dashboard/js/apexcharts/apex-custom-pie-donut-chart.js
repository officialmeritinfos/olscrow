    ...
    if(document.getElementById("apex-image-with-pie-chart")){
        var options = {
            ...
            fill: {
                ...
                opacity: 0.85,
                image: {
                        src: ['assets/images/chart-img/chart-img-1.jpg', 'assets/images/chart-img/chart-img-2.jpg', 'assets/images/chart-img/chart-img-3.jpg', 'assets/images/chart-img/chart-img-4.jpg'],
                    width: 25,
                    imagedHeight: 25
                },
            },
